...
function Projects() {
  ...
  return (
    <div className="min-h-[110vh] bg-black relative pb-20 w-full z-30 text-white grid place-items-center">
      <div className="w-[85%] py-40 flex flex-col gap-10 items-center min-h-[80vh] h-max mb-[10vh]">
        ...
        <div className="project-container flex flex-col justify-center items-center gap-4">
          <div className="projects flex justify-center items-center h-fit flex-col gap-8 md:gap-20">
              ...
              return (
                <div className="project project-1 flex flex-col md:flex-row gap-4 md:gap-8 w-full relative">
                  ...
                  <div className="md:flex w-full justify-between items-center md:gap-14">
                    ...
                    <div className="relative mt-4 h-5/6 md:mt-0 w-full md:w-5/12 flex flex-col gap-4 md:gap-6">
            ...
            {/* <div className="project project-1 flex flex-col md:flex-row gap-4 md:gap-8 w-full relative">
              ...
              <div className="md:flex bg-fuchsia-700 w-full justify-between md:gap-14">
                <div className="flex-1 flex justify-center items-center h-[25vh] md:h-[40vh] rounded-2xl shadow-sm bg-white relative overflow-hidden">
            ...
            <div className="project project-2 flex flex-col md:flex-row gap-4 md:gap-8 w-full">
              <p className="text-[4rem] md:text-[8rem] heading leading-tight">
                2.
              </p>
            ...
            <div className="project project-3 flex flex-col md:flex-row gap-4 md:gap-8 w-full">
              <p className="text-[4rem] md:text-[8rem] heading leading-tight">
                3.
              </p>
              <div className="md:flex md:gap-14">
          ...
          <button className="px-5 py-3 border mt-10 border-white text-sm hover:bg-white text-white hover:text-black">
            See More
          </button>
        </div>
      </div>
